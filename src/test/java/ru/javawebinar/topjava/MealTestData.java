...
public class MealTestData {
    ...
    public static Meal getUpdatedBadCalories() {
        return new Meal(MEAL1_ID, meal1.getDateTime().plus(2, ChronoUnit.MINUTES), "Обновленный завтрак", 8);
    }

    public static Meal getUpdatedBadDescription() {
        return new Meal(MEAL1_ID, meal1.getDateTime().plus(2, ChronoUnit.MINUTES), "t", 200);
    }
}
