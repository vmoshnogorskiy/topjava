...
class ProfileRestControllerTest extends AbstractControllerTest {
    ...
    @Test
    void registerUnValidPassword() throws Exception {
        UserTo newTo = new UserTo(null, "newName", "newemail@ya.ru", "new", 1500);
        ResultActions action = perform(MockMvcRequestBuilders.post(REST_URL)
                .contentType(MediaType.APPLICATION_JSON)
                .content(JsonUtil.writeValue(newTo)))
                .andDo(print())
                .andExpect(ERROR_INFO_MATCHER.contentJson(errInfoProfile));
    }
    ...
    @Test
    void updateUnValidPassword() throws Exception {
        UserTo updatedTo = new UserTo(null, "newName", "user@yandex.ru", "123", 1500);
        perform(MockMvcRequestBuilders.put(REST_URL).contentType(MediaType.APPLICATION_JSON)
                .with(userHttpBasic(user))
                .content(JsonUtil.writeValue(updatedTo)))
                .andDo(print())
